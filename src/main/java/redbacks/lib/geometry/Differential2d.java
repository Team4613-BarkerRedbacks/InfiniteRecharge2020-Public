 ...
 * It extends WPI's {@link Twist2d} which is documented by WPI as merely a change in distance.
 * It was written to extend Twist2d so that it could be used in replacement of Twist2d so as to be compatible with WPI libraries.
 * 
...
public class Differential2d extends Twist2d{
	 ...
	 * @param divisor.
	 * @returnA Differential2d with the dx, dy, dtheta and period being scaled by the provided divisor.
	 */
